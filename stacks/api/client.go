...
import (
	...
	"github.com/arnac-io/go-stacks/stacks/config"
...
// APIClient manages communication with the Stacks Blockchain API API vSTACKS_API_VERSION
...
func NewAPIClient(cfg *config.Configuration) *APIClient {
	...
	c.BurnBlocksAPI = (*BurnBlocksAPIService)(&c.common)
	c.FaucetsAPI = (*FaucetsAPIService)(&c.common)
	c.FeesAPI = (*FeesAPIService)(&c.common)
	c.InfoAPI = (*InfoAPIService)(&c.common)
	c.MempoolAPI = (*MempoolAPIService)(&c.common)
	c.MicroblocksAPI = (*MicroblocksAPIService)(&c.common)
	c.NamesAPI = (*NamesAPIService)(&c.common)
	c.NonFungibleTokensAPI = (*NonFungibleTokensAPIService)(&c.common)
	c.ProofOfTransferAPI = (*ProofOfTransferAPIService)(&c.common)
	c.SearchAPI = (*SearchAPIService)(&c.common)
	c.SmartContractsAPI = (*SmartContractsAPIService)(&c.common)
	c.StackingAPI = (*StackingAPIService)(&c.common)
	c.StackingRewardsAPI = (*StackingRewardsAPIService)(&c.common)
...
func (c *APIClient) callAPI(request *http.Request) (*http.Response, error) {
	...
	if c.cfg.Logger.Verbose {
		dump, err := httputil.DumpRequestOut(request, true)
		if err != nil {
			return nil, err
		}
		c.cfg.Logger.TryLog("API Call", map[string]string{"url": request.URL.String(), "request": string(dump)})
		// log.Printf("\n%s\n")
	}
	...
	if c.cfg.Logger.Verbose {
		...
		// log.Printf("\n%s\n")
		c.cfg.Logger.TryLog("API Call Response", map[string]string{"code": fmt.Sprint(resp.StatusCode), "response": string(dump)})
	}
	return resp, err
}
