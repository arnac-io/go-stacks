...
var _ utils.MappedNullable = &TenureChangeTransaction{}

// TenureChangeTransaction Describes representation of a Type 7 Stacks transaction: Tenure Change
...
func (o *TenureChangeTransaction) GetExecutionCostRuntime() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TenureChangeTransaction) GetExecutionCostRuntimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TenureChangeTransaction) SetExecutionCostRuntime(v int64) {
