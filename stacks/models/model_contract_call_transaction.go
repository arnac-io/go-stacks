...
// checks if the ContractCallTransaction type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ContractCallTransaction{}
...
// and a boolean to check if the value has been set.
func (o *ContractCallTransaction) GetAnchorModeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ContractCallTransaction) SetEvents(v []TransactionEvent) {
	o.Events = v
}
...
func (o ContractCallTransaction) ToMap() (map[string]interface{}, error) {
...
func (o *ContractCallTransaction) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ContractCallTransaction(varContractCallTransaction)
