...
// checks if the CoinbaseTransaction type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CoinbaseTransaction{}
...
func (o *CoinbaseTransaction) GetExecutionCostRuntime() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CoinbaseTransaction) GetExecutionCostRuntimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CoinbaseTransaction) SetExecutionCostRuntime(v int64) {
...
func (o CoinbaseTransaction) ToMap() (map[string]interface{}, error) {
...
func (o *CoinbaseTransaction) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CoinbaseTransaction(varCoinbaseTransaction)
