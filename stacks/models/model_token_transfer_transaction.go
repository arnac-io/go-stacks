...
func (o *TokenTransferTransaction) GetExecutionCostRuntime() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TokenTransferTransaction) GetExecutionCostRuntimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TokenTransferTransaction) SetExecutionCostRuntime(v int64) {
