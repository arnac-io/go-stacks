...
func (o *PoisonMicroblockTransaction) GetExecutionCostRuntime() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PoisonMicroblockTransaction) GetExecutionCostRuntimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PoisonMicroblockTransaction) SetExecutionCostRuntime(v int64) {
